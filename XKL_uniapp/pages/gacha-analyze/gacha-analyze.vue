<template>
    <view class="gacha-analyze-container">
        <view class="gacha-analyze-title">▌少女前线2追放抽卡分析</view>
        <view class="input-container">
            <view class="input-title">请粘贴抽卡分析请求</view>
            <textarea 
                class="custom-input"
                placeholder="例如latest_request.json里的请求"
            />
        </view>
